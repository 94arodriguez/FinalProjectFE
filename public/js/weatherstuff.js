...
const refreshMETAR = (station_id) => {
  const stationElement = document.querySelector("#metar_table");
...
const updateWeatherOutput = async (json, site) => {
  ...
  if (
    metar.station_id[0].startsWith("K") ||
    ...
    pressure_output = `<strong>PRESSURE:</strong> ${inHgtohPa(
      altim_in_hg
    )} hPa (${altim_in_hg} inHg)`;
  }
...
const selectWeatherIcon = async (json) => {
  // weather icons
  let weather_icon_img_src = "img/noaa/day/Sunny.png";
    ...
    .then((json) => {
      ...
      if (wxstr) {
        ...
        if (snow_pattern.exec(wx_string)) {
          ...
          if (day) {
            weather_icon_img_src = `${IMG_DAY_PREFIX}ModSnowSwrsDay.png`;
          } else {
            weather_icon_img_src = `${IMG_NIGHT_PREFIX}ModSnowSwrsNight.png`;
          }
        }
        ...
        if (snow_frozen_pattern.exec(wx_string)) {
          weather_icon_img_alt = "snow";
          if (day) {
            weather_icon_img_src = `${IMG_DAY_PREFIX}HeavySleetSwrsDay.png`;
          } else {
            weather_icon_img_src = `${IMG_NIGHT_PREFIX}HeavySleetSwrsNight.png`;
          }
        }
        ...
        if (light_rain_pattern.exec(wx_string)) {
          ...
          if (day) {
            weather_icon_img_src = `${IMG_DAY_PREFIX}IsoRainSwrsDay.png`;
          } else {
            weather_icon_img_src = `${IMG_NIGHT_PREFIX}IsoRainSwrsNight.png`;
          }
        }
        ...
        if (thunderstorm_pattern.exec(wx_string)) {
          ...
          if (day) {
            weather_icon_img_src = `${IMG_DAY_PREFIX}CloudRainThunder.png`;
          } else {
            weather_icon_img_src = `${IMG_NIGHT_PREFIX}PartCloudRainThunderNight.png`;
          }
        }
        ...
        if (haze_pattern.exec(wx_string)) {
          ...
          if (day) {
            weather_icon_img_src = `${IMG_DAY_PREFIX}Fog.png`;
          } else {
            weather_icon_img_src = `${IMG_NIGHT_PREFIX}Fog.png`;
          }
        }
        ...
        if (mist_pattern.exec(wx_string)) {
          ...
          if (day) {
            weather_icon_img_src = `${IMG_DAY_PREFIX}Mist.png`;
          } else {
            weather_icon_img_src = `${IMG_NIGHT_PREFIX}Mist.png`;
          }
        }
        ...
        if (skycond) {
          ...
          if (gusts) {
            ...
            if (greatest == "SKC") {
              ...
              if (day) {
                weather_icon_img_src = `${IMG_DAY_PREFIX}wind.png`;
              } else {
                weather_icon_img_src = `${IMG_NIGHT_PREFIX}wind.png`;
              }
            }
            ...
            //WIND SCT - https://www.weather.gov/images/nws/newicons/wind_sct.png
              ...
              if (day) {
                weather_icon_img_src = `${IMG_DAY_PREFIX}PartlyCloudyDay.png`;
              } else {
                weather_icon_img_src = `${IMG_NIGHT_PREFIX}PartlyCloudyNight.png`;
              }
            }
            //WIND BKN - https://www.weather.gov/images/nws/newicons/wind_bkn.png
              ...
              if (day) {
                weather_icon_img_src = `${IMG_DAY_PREFIX}Cloudy.png`;
              } else {
                weather_icon_img_src = `${IMG_NIGHT_PREFIX}Overcast.png`;
              }
            }
          ...
          //no gusts
            ...
            if (greatest == "SKC") {
              ...
              if (day) {
                weather_icon_img_src = `${IMG_DAY_PREFIX}Sunny.png`;
              } else {
                weather_icon_img_src = `${IMG_NIGHT_PREFIX}Clear.png`;
              }
            }
